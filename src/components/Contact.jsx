...
const Contact = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Submission error:", error);
      alert("Data is submitted successfully"); // Note: Your original code had a typo in "Succesfully"
    } finally {
              ...
              <form onSubmit={handleSubmit}>
                <div className="rounded-lg mt-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      type="submit"
                      className="w-full bg-blue-700 text-white py-2 px-4 rounded-md hover:bg-blue-800 transition flex items-center justify-center"
